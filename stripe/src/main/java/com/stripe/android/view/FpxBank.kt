...
enum class FpxBank(
    ...
    Maybank2E(
        "MBB0228", "maybank2e", "Maybank2E",
        R.drawable.stripe_ic_bank_maybank
    ),
    Ocbc(
        "OCBC0229", "ocbc", "OCBC Bank",
        R.drawable.stripe_ic_bank_ocbc
    ),
    StandardChartered(
        "SCB0216", "standard_chartered", "Standard Chartered",
